			...
			<div class="row">
				<div class="col-lg-3">
					<div class="acc-leftbar">
						<div class="nav nav-tabs" id="nav-tab" role="tablist">
							...
							<a class="nav-item nav-link" id="nav-security-login" data-toggle="tab" href="#nav-security-login" role="tab" aria-controls="nav-security-login" aria-selected="false">
				...
				<div class="col-lg-9">
					<div class="tab-content" id="nav-tabContent">
						...
						<div class="tab-pane fade" id="nav-security-login" role="tabpanel" aria-labelledby="nav-security-login">
							<div class="acc-setting">
								<h3>Requests</h3>
								<div class="requests-list">
									<div class="request-details">
